function [ElMatrices] = KM_matrix_fluid(BasicMatrices, CompStruct, FEMatrices, ...
...
%
% function [K1Matrix, K2Matrix, K3Matrix, MMatrix]...
%             = KM_matrix_fluid(BasicMatrices, ElPhysProps, ...
%                              dxNLMatrix, dyNLMatrix, ...
%                              TriProps)
%
%  Inputs - 
%
...
ElMatrices.MMatrix = delta*ElMatrices.NtRho2LambdaNMatrix;
