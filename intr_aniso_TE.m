...
% IntrTE3.freqs=[0.5:0.25:25]; 
IntrTE3.freqs=[0.5:0.25:25]; 
% IntrTE3.freqs=[1:1:Rt15]; 
IntrTE3.num_eigs_class_show=2;
IntrTE3.changer_12='y'; % if V_mode_1>qSV and V_mode_1 < V_mode_2, then change V_mode_1 and V_mode_2

IntrTE3.max_harm_limit=0.1; % For symmetry classification
...
% plot parameters
IntrTE3.show_modes=['y';'y';'y';'y';'n';'n';'n']; % 0-mode,1-mode (p/m),2-mode (p/m),3-mode (p/m) 
IntrTE3.slowness='y'; IntrTE3.velocity='n'; 
IntrTE3.close_figs='y'; IntrTE3.num_fig=1590; IntrTE3.font_size=12; IntrTE3.slowness_limits=[100 250]; IntrTE3.velocity_limits=[1300 3200];
IntrTE3.linestyle=['-'; '-'; '-']; IntrTE3.linewidth=[2; 2; 2; 1]; IntrTE3.color=['r'; 'b'; 'k'; 'm'];
IntrTE3.marker={'o'; 'o'; '^'}; IntrTE3.markersize=[3; 3; 3];
...
if exist(fname,'file')>0
    ...
    if strcmp(IntrTE3.slowness,'y')
       ...
       hold on; box on; xlim([0  f_max+1]); ylim(IntrTE3.slowness_limits);
       plot(IntrTE3.freqs_count,IntrTE3.Slowness(1:length(IntrTE3.freqs_count),1:CompStructA.Advanced.num_eig_max), ...
           ...
           'LineStyle','none','Linewidth',IntrTE3.linewidth(1),'Color','r');
    ...
    if strcmp(IntrTE3.velocity,'y')
       % Slowness
       f_max=max(CompStructA.Model.f_array);
       
       hf_full=figure(IntrTE3.num_fig+12+1); 
       set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
       hold on; box on; 
       cconst=12.*0.0254*1e6;
       xlim([0  f_max+1]); ylim(IntrTE3.velocity_limits);
       plot(IntrTE3.freqs_count,cconst./IntrTE3.Slowness(1:length(IntrTE3.freqs_count),1:CompStructA.Advanced.num_eig_max), ...
           'Marker',char(IntrTE3.marker(1)),'Markersize',IntrTE3.markersize(1), ...
           'LineStyle','none','Linewidth',IntrTE3.linewidth(1),'Color','r');

       freq_var=[0 IntrTE3.freqs_count f_max+1];
       qP_val=ones(length(freq_var),1).*(1e3*CompStructA.Asymp.V_qP); 
       qSV_val=ones(length(freq_var),1).*(1e3*CompStructA.Asymp.V_qSV); 
       SH_val =ones(length(freq_var),1).*(1e3*CompStructA.Asymp.V_SH);
       St_val =ones(length(freq_var),1).*(1e3*CompStructA.Asymp.V_St);
       plot(freq_var,qP_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(4));
       plot(freq_var,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(3));
       plot(freq_var,SH_val ,'LineStyle',IntrTE3.linestyle(3),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
       plot(freq_var,St_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(4));
...
for iff=IntrTE3.nfreqs
    ...
    for ieig=IntrTE3.neigs
        ...
        if var_ind(4)==1 % 3d-pole
           if TE_PZp_f_e_h(ieig,4)>=TE_PZm_f_e_h(ieig,4)
              Class_TE_3p(ifreq,ieig,1)=TE_f_eigs_Ir_Nh(ieig,NrrF-1,4);
              Class_TE_3p(ifreq,ieig,2)=ieig;
           else
              Class_TE_3m(ifreq,ieig,1)=TE_f_eigs_Ir_Nh(ieig,NrrF-1,4);
...
% Stoneley
if strcmp(IntrTE3.show_modes(1),'y')
    
    hf0=figure(IntrTE3.num_fig+10);
    set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
    hold on; box on; xlim([freq_countA(1) freq_countA(end)]); ylim(IntrTE3.slowness_limits);
    plot(IntrTE3.freqs_count,Class_TE_0(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
        'Marker',char(IntrTE3.marker(1)),'MarkerSize',IntrTE3.markersize(1),'LineWidth',IntrTE3.linewidth(1));
    plot(freq_countA,SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
    plot(freq_countA,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
    xlabel('f (kHz)'); ylabel('Slowness (\mus/f)'); 
    title(strcat(Title_Add,' Monopole modes'));
    
%     hf0=figure(IntrTE3.num_fig+11);
%     set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
%     hold on; box on; xlim([freq_countA(1) freq_countA(end)]); 
%     vary=0.3048e6./IntrTE3.slowness_limits; ylim([vary(2) vary(1)]);
%     plot(IntrTE3.freqs_count,0.3048e6./Class_TE_0(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
%         'Marker',char(IntrTE3.marker(1)),'MarkerSize',IntrTE3.markersize(1),'LineWidth',IntrTE3.linewidth(1));
%     plot(freq_countA,0.3048e6./SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
%     plot(freq_countA,0.3048e6./qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
%     xlabel('f (kHz)'); ylabel('Velocity (m/s)'); 
%     title(strcat(Title_Add,' Monopole modes'));
end

% Dypole +
if strcmp(IntrTE3.show_modes(2),'y')
    
    hf1p=figure(IntrTE3.num_fig+20);
    set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
    hold on; box on; xlim([freq_countA(1) freq_countA(end)]); ylim(IntrTE3.slowness_limits);
    plot(IntrTE3.freqs_count, Class_TE_1p(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
        'Marker',char(IntrTE3.marker(1)),'MarkerSize',IntrTE3.markersize(1),'LineWidth',IntrTE3.linewidth(1));
    plot(freq_countA,SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
    plot(freq_countA,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
    xlabel('f (kHz)'); ylabel('Slowness (\mus/f)'); 
...
%     hf1p=figure(IntrTE3.num_fig+21);
%     set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
%     hold on; box on; xlim([freq_countA(1) freq_countA(end)]);
%     vary=0.3048e6./IntrTE3.slowness_limits; ylim([vary(2) vary(1)]);
%     plot(IntrTE3.freqs_count, 0.3048e6./Class_TE_1p(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
%         'Marker',char(IntrTE3.marker(1)),'MarkerSize',IntrTE3.markersize(1),'LineWidth',IntrTE3.linewidth(1));
%     plot(freq_countA,0.3048e6./SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
%     plot(freq_countA,0.3048e6./qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
%     xlabel('f (kHz)'); ylabel('Slowness (\mus/f)'); 
...
% Dypole -
if strcmp(IntrTE3.show_modes(3),'y')
    
    hf1m=figure(IntrTE3.num_fig+21);
    set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
    hold on; box on; xlim([freq_countA(1) freq_countA(end)]); ylim(IntrTE3.slowness_limits);
    plot(IntrTE3.freqs_count, Class_TE_1m(:,1:IntrTE3.num_eigs_class_show,ikey), 'LineStyle','none', ...
        'Marker',char(IntrTE3.marker(2)),'MarkerSize',IntrTE3.markersize(2),'LineWidth',IntrTE3.linewidth(2));
    plot(freq_countA,SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
    plot(freq_countA,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
    xlabel('f (kHz)'); ylabel('Slowness (\mus/f)');
    title(strcat(Title_Add,' Flexural modes -'));
...
% Quadupole +
if strcmp(IntrTE3.show_modes(4),'y')
    
    hf2p=figure(IntrTE3.num_fig+30);
    set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
    hold on; box on; xlim([freq_countA(1) freq_countA(end)]); ylim(IntrTE3.slowness_limits);
    plot(IntrTE3.freqs_count, Class_TE_2p(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
        'Marker',char(IntrTE3.marker(1)),'MarkerSize',IntrTE3.markersize(1),'LineWidth',IntrTE3.linewidth(1));
    plot(freq_countA,SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
    plot(freq_countA,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
    xlabel('f (kHz)'); ylabel('Slowness (\mus/f)');
...
%     hf2p=figure(IntrTE3.num_fig+31);
%     set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
%     hold on; box on; xlim([freq_countA(1) freq_countA(end)]);
%     vary=0.3048e6./IntrTE3.slowness_limits; ylim([vary(2) vary(1)]);
%     plot(IntrTE3.freqs_count, 0.3048e6./Class_TE_2p(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
%         'Marker',char(IntrTE3.marker(1)),'MarkerSize',IntrTE3.markersize(1),'LineWidth',IntrTE3.linewidth(1));
%     plot(freq_countA,0.3048e6./SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
%     plot(freq_countA,0.3048e6./qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
%     xlabel('f (kHz)'); ylabel('Slowness (\mus/f)');
...
% Quadupole -
if strcmp(IntrTE3.show_modes(5),'y')
    
    hf2m=figure(IntrTE3.num_fig+31);
    set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
    hold on; box on; xlim([freq_countA(1) freq_countA(end)]); ylim(IntrTE3.slowness_limits);
    plot(IntrTE3.freqs_count, Class_TE_2m(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
        'Marker',char(IntrTE3.marker(2)),'MarkerSize',IntrTE3.markersize(2),'LineWidth',IntrTE3.linewidth(2));
    plot(freq_countA,SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
    plot(freq_countA,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
    xlabel('f (kHz)'); ylabel('Slowness (\mus/f)');
...
% 3pole +
if strcmp(IntrTE3.show_modes(6),'y')
    
    hf3p=figure(IntrTE3.num_fig+40);
    set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
    hold on; box on; xlim([freq_countA(1) freq_countA(end)]); ylim(IntrTE3.slowness_limits);
    plot(IntrTE3.freqs_count, Class_TE_3p(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
        'Marker',char(IntrTE3.marker(1)),'MarkerSize',IntrTE3.markersize(1),'LineWidth',IntrTE3.linewidth(1));
    plot(freq_countA,SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
    plot(freq_countA,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
    xlabel('f (kHz)'); ylabel('Slowness (\mus/f)');
...
% 3pole -
if strcmp(IntrTE3.show_modes(7),'y')
    
    hf3p=figure(IntrTE3.num_fig+41);
    set(gca,'FontSize',IntrTE3.font_size); set(gca,'ColorOrder',ColorOrder);
    hold on; box on; xlim([freq_countA(1) freq_countA(end)]); ylim(IntrTE3.slowness_limits);
    plot(IntrTE3.freqs_count, Class_TE_3m(:,1:IntrTE3.num_eigs_class_show,ikey),'LineStyle','none', ...
        'Marker',char(IntrTE3.marker(2)),'MarkerSize',IntrTE3.markersize(2),'LineWidth',IntrTE3.linewidth(2));
    plot(freq_countA,SH_val ,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(1));
    plot(freq_countA,qSV_val,'LineStyle',IntrTE3.linestyle(2),'Linewidth',IntrTE3.linewidth(2),'Color',IntrTE3.color(2));
    xlabel('f (kHz)'); ylabel('Slowness (\mus/f)');
