%function [p,t,fnum,edge,stats,pbnd] = meshfaces(node,edge,face,hdata,options)
function [p,t,fnum,edge,stats,pbnd,CompStruct] = meshfaces(node,edge,face,CompStruct)
...
try                                                   
   ...
   hdata=[];
   if isfield(CompStruct.Mesh,'hmax'), hdata.hmax=CompStruct.Mesh.hmax; end
   ...
   if isfield(CompStruct.Mesh,'output')
      if strcmpi(CompStruct.Mesh.output,'yes'), options.output=(true); end
   else
